...
// Agora vamos testar a classe LinkedList

// criando (instanciando) uma nova lista a partir da classe
...
console.log('Iremos remover o elemento: '+ listaEncadeada.removeAt(5));
// imprimindo o conteúdo da lista 
console.log('A lista encadeada possui o conteúdo: '+ listaEncadeada.toString());

//removendo um elemento diretamente pelo valor
console.log('Iremos remover o elemento: '+ listaEncadeada.remove('Luis'));
// imprimindo o conteúdo da lista 
console.log('A lista encadeada possui o conteúdo: '+ listaEncadeada.toString());
// verificando o tamanho da lista
console.log('A lista encadeada possui '+ listaEncadeada.size()+' elementos');
// agora verificando quem é o primeiro elemento da lista
console.log('O primeiro elemento da lista é: '
    + listaEncadeada.getHead().element 
    + ' que encontra-se na posição: ' 
